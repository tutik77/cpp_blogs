...
using namespace drogon_model::auth_service;
...
const std::vector<typename Users::MetaData> Users::metaData_ = {
    ...
    {"login", "std::string", "character varying", 50, 0, 0, 1},
    {"password", "std::string", "text", 0, 0, 0, 1},
    {"created_at", "::trantor::Date", "timestamp without time zone", 0, 1, 0,
     0}};
...
Users::Users(
  ...
  if (!pMasqueradingVector[2].empty() &&
    ...
    if (!pJson[pMasqueradingVector[2]].isNull()) {
      login_ = std::make_shared<std::string>(
...
const std::vector<std::string> &Users::insertColumns() noexcept {
  static const std::vector<std::string> inCols = {"name", "login", "password"};
  return inCols;
}
